...
def create_unified_task(user_data):
    ...
    task = Task(
        ...
        - Provide 3-4 key care steps.
        
        2. HOSPITALS:
        - {hospital_scope}
        - IMPORTANT: Provide 3 DIFFERENT, REAL hospitals using the hospital_tool.
        - Each hospital MUST have its name and a SPECIFIC UNIQUE address.
